...
struct RefSol{
  ...
  static inline Cplx Compute(Real r, Real theta, const int& n, Real& rr=1., const Real& k=1.){
    return AnalyticalSolution<Op::Trait::EqType,Op::Trait::OpType,Op::Trait::Dim>::Compute(r,theta,n,rr,k); }
